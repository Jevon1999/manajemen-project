...
@php
    $iconMap = [
        ...
        'tasks' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path>',
        ...
        'notifications' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-5 5v-5zm-6-10a4 4 0 11-8 0 4 4 0 018 0zM9.058 9h.01M9.058 15h.01M13 7V3a1 1 0 011-1h2a1 1 0 011 1v4M5 9h4"></path>',
        ...
        'switch' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"></path>',
    ...
    $iconPath = $iconMap[$icon] ?? $iconMap['dashboard']; // Default to dashboard icon
@endphp

<svg class="w-5 h-5 mr-3 text-blue-400 group-hover:text-blue-300 transition-colors" 
     fill="none" 
     stroke="currentColor" 
     viewBox="0 0 24 24" 
     aria-hidden="true">
