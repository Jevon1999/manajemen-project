...
<div x-data="notificationBell()" x-init="init()" class="relative">
    ...
    <div x-show="open" 
        ...
        class="absolute top-full mt-2 right-0 -translate-x-[calc(100%-3rem)] sm:-translate-x-1/2 w-[90vw] sm:w-96 md:w-[30rem] lg:w-[32rem] max-w-lg bg-white rounded-xl shadow-2xl border border-gray-200 z-50 overflow-hidden"
        style="display: none;">
