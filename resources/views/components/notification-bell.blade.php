...
<div x-data="notificationBell()" x-init="init()" class="relative">
    ...
    <div x-show="open" 
        ...
        class="fixed inset-x-4 top-16 sm:absolute sm:inset-x-auto sm:top-full sm:mt-2 sm:right-0 sm:-translate-x-1/2 w-auto sm:w-96 max-w-lg bg-white rounded-xl shadow-2xl border border-gray-200 z-50 overflow-hidden"
        style="display: none;">
